function [PC_preds,MDL,reportind] = xgb_model_notest(PCs,Features, start_trees, start_learn, start_gamma,start_depth, start_child,start_subsample,start_lambda, start_alpha)
...
preds = [Features.hours(:,:),Features.delta_hours(:,:),Features.delta_solmin(:,:),Features.solzen(:,:),Features.delta_solzen(:,:),mean(Features.solzen,2),Features.azim(:,:),Features.delta_azim(:,:)...
    ,mean(Features.azim,2),Features.xco2(:,:),Features.delta_xco2(:),mean(Features.xco2(:,:),2),Features.temp(:,:),Features.delta_temp(:), mean(Features.temp,2)...
