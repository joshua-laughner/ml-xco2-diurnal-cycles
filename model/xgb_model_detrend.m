...
preds = [Features.delta_hours(:,:),Features.solzen(:,:),Features.delta_solzen(:,:)./Features.delta_hours(:,:),mean(Features.solzen,2),Features.azim(:,:),Features.delta_azim(:,:)./Features.delta_hours(:,:)...
...
test_preds = [test_features.delta_hours(:,:),test_features.solzen(:,:),test_features.delta_solzen(:,:)./test_features.delta_hours(:,:),mean(test_features.solzen,2),test_features.azim(:,:),test_features.delta_azim(:,:)./test_features.delta_hours(:,:)...
