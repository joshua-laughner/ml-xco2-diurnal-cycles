...
Big_Fig.(skip).inbag_draw_predicted = inbag_draw_predicted;
Big_Fig.(skip).inbag_draw_real = inbag_draw_real;
Big_Fig.(skip).oob_draw_predicted = oob_draw_predicted;
Big_Fig.(skip).oob_draw_real = oob_draw_real;
Big_Fig.(skip).val_draw_predicted = val_draw_predicted;
Big_Fig.(skip).val_draw_real = val_draw_real;

Big_Fig.(skip).inbag_predicted = inbag_predicted;
Big_Fig.(skip).inbag_real = inbag_real;
Big_Fig.(skip).oob_predicted = oob_predicted;
Big_Fig.(skip).oob_real = oob_real;
Big_Fig.(skip).val_predicted = long_predicted;
Big_Fig.(skip).val_real = long_real;
