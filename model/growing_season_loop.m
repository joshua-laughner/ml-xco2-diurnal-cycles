...
inbag_draw_real = InBag_Comp(:,22)- InBag_Comp(:,6);
inbag_draw_predicted = InBag_Cycles(:,22) - InBag_Cycles(:,6);

oob_draw_real = OOB_Comp(:,22)- OOB_Comp(:,6);
oob_draw_predicted = OOB_Cycles(:,22) - OOB_Cycles(:,6);

val_draw_real = Test_Quart_Hour(:,22)- Test_Quart_Hour(:,6);
val_draw_predicted = Predicted_Cycles(:,22) - Predicted_Cycles(:,6);

Grow_Model.(skip).inbag_draw_predicted = inbag_draw_predicted;
Grow_Model.(skip).inbag_draw_real = inbag_draw_real;
Grow_Model.(skip).oob_draw_predicted = oob_draw_predicted;
Grow_Model.(skip).oob_draw_real = oob_draw_real;
Grow_Model.(skip).val_draw_predicted = val_draw_predicted;
Grow_Model.(skip).val_draw_real = val_draw_real;

Grow_Model.(skip).inbag_predicted = inbag_predicted;
Grow_Model.(skip).inbag_real = inbag_real;
Grow_Model.(skip).oob_predicted = oob_predicted;
Grow_Model.(skip).oob_real = oob_real;
Grow_Model.(skip).val_predicted = long_predicted;
Grow_Model.(skip).val_real = long_real;
%save([savepath,'error_',num2str(method),'_Big_Fig.mat'],'Big_Fig') 
end

save([savepath,'error_',num2str(method),'_Grow_Model.mat'],'Grow_Model')
end
