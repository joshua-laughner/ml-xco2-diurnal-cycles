function [Subsampled_Structs] = add_GEOS_all(Subsampled_Structs, Daily_Structs)
...
for loc = 1:length(locations)
    ...
    Daynames = Daily_Structs.(locations{loc}).days;
    solmin_array = Daily_Structs.(locations{loc}).solar_min;
    ...
    count = 0;
    site_name = (locations{loc});
    if strcmp(site_name,'Lauder')
        site_name = 'Lau';
    elseif strcmp(site_name,'Lamont')
        site_name = 'Lam';
    end
