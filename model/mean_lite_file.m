%% extracting the lite file data and making a Struct of averages
clear all
...
for i = 1:length(Crossing_Struct)
    ...
    if oco2_lite_file ~= Crossing_Struct(i).oco2_lite_file
    oco2_lite_file = Crossing_Struct(i).oco2_lite_file;
