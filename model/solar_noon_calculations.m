...
sounding_id = Crossing_Struct(i).oco2_sounding_id_start; %like, close enough right
...
save('C:\Users\cmarchet\Box\JPL\Processed_Data\date_string.mat','date_string')
%%
...
OCO2_PF_distance = distance(Lat,Lon,[Lite_Struct.OCO2_latitude],[Lite_Struct.OCO2_longitude],wgs84);
OCO3_PF_distance = distance(Lat,Lon,[Lite_Struct.OCO3_latitude],[Lite_Struct.OCO3_longitude],wgs84);
